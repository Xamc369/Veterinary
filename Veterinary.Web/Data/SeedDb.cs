...
namespace Veterinary.Web.Data
{
    public class SeedDb
    {
        ...
        private readonly Helpers.IUserHelper _userHelper;
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1001", "Ximena", "Moreno", "xime250389@gmail.com", "0979108738", "Prados del Condado", "Admin");
            var customer = await CheckUserAsync("2002", "Alexandra", "Castro", "alex.castro@hotmail.com", "0979108739", "Whymper N2770 y Orellana", "Customer");
        ...
        private async Task CheckServiceTypesAsync()
        {
            if (!_dataContext.ServiceTypes.Any())
            {
                ...
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Emergencia" });
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Vacunación" });
                _dataContext.ServiceTypes.Add(new ServiceType { Name = "Hospitalización" });
                await _dataContext.SaveChangesAsync();
            }
        }
        ...
        private async Task CheckPetTypesAsync()
        {
            if (!_dataContext.PetTypes.Any())
            {
                ...
                _dataContext.PetTypes.Add(new PetType { Name = "Pájaro" });
